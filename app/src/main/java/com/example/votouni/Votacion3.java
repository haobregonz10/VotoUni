...
public class Votacion3 extends AppCompatActivity {
    CheckBox CBT3L1;
    CheckBox CBT3L2;
    Button BtnVotarT3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CBT3L1= findViewById(R.id.CBT3L1);
        CBT3L2= findViewById(R.id.CBT3L2);
        BtnVotarT3= findViewById(R.id.btn_T3);
        mFirestore= FirebaseFirestore.getInstance();
        PBT3= findViewById(R.id.progressBarT3);
        PBT3.setVisibility(View.INVISIBLE);
        contexto3=this;
        BtnVotarT3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PBT3.setVisibility(View.VISIBLE);
                ...
                if(ValidarCheck()){
                    ...
                    Toast.makeText(Votacion3.this,"Elija solo a una lista!",Toast.LENGTH_SHORT).show();
                    PBT3.setVisibility(View.INVISIBLE);
                }
    ...
    private void InsertarVotos() throws BadPaddingException, UnsupportedEncodingException, NoSuchAlgorithmException, IllegalBlockSizeException, NoSuchProviderException, NoSuchPaddingException, InvalidKeyException, InvalidKeySpecException {
        ...
        mFirestore.collection("Votos").add(map).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            ...
            public void onSuccess(DocumentReference documentReference) {
                Toast.makeText(Votacion3.this,"Su voto se registró correctamente!",Toast.LENGTH_SHORT).show();
                PBT3.setVisibility(View.INVISIBLE);
                new tercervotovalido(contexto3);
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Votacion3.this,"No se pudo registrar su voto!",Toast.LENGTH_SHORT).show();
                PBT3.setVisibility(View.INVISIBLE);
    ...
    private boolean ValidarCheck(){
        if(CBT3L1.isChecked() && CBT3L2.isChecked()){
            return false;
        }else{
            return true;
        }
